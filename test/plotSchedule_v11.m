...
% Dimensions
flow_bar_thickness          = 0.3        ; % flow bar width (day)
...
project_duration = sol.xf_NF(1,1) ;
...
Total_Work_Interruption = total_idle_time ;

%% Calculate Project Material and Equipment Cost
load Material_Equipment_Cost.mat
    ...
    for it_crew = 1:num_crews(k)
        for i = 1:NI
            total_material_cost  = total_material_cost + ...
                Material_Equipment_Cost(k,1)*Quantity(k,i) ;
            total_equipment_cost = total_equipment_cost + ...
                Quantity(k,i)/Productivity(k,it_crew)*Material_Equipment_Cost(k,2) ;
